...
class VerificatorPage extends StatefulWidget {
  final User? user;
  final DocumentSnapshot? doccumentSnapshot;
  // ignore: use_key_in_widget_constructors
  const VerificatorPage({this.user, this.doccumentSnapshot});
  _VerificatorPageState createState() => _VerificatorPageState();
}

class _VerificatorPageState extends State<VerificatorPage> {
  ...
  getDataReimburse() async {
    _list = await reimburseOperations.getDataVerificator(reimburseModel);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Home Verificator'),
        centerTitle: true,
